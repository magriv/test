...
/*
    Задача:
    Спроектировать и описать на РНР объектную модель для графического редактора.
    При помощи этого графического редактора можно рисовать прямоугольники, треугольники и круги.
    Нарисованные фигуры можно перемещать, масштабировать, а также менять их цвет
*/
